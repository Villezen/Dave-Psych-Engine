...
{
	public static var daveVersion:String = '2.0'; //This is also used for Discord RPC
	...
	override function create()
	{
		...
		var versionShit:FlxText = new FlxText(12, FlxG.height - 64, 0, "Dave's Revenge v" + daveVersion, 12);
